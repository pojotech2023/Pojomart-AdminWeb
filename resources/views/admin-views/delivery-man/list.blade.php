        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/employee.png')}}" class="w--24" alt="{{ translate('deliveryman') }}">
                </span>
                <span>
                            ...
                            <td>
                                <div class="table--media">
                                    <img class="rounded-full"
                                        src="{{ asset('storage/delivery-man/' . $deliveryman->image) }}"
                                        alt="{{ translate('deliveryman') }}"
                                        onerror="this.src='{{ asset_path('assets/admin/img/160x160/2.png') }}'">
