    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center">
                <img width="20" class="avatar-img" src="{{asset_path('assets/admin/img/firebase.png')}}" alt="">
                    ...
                    <ul class="nav nav-tabs nav--tabs border-0 ml-3">
                        <li class="nav-item mr-2 mr-md-4">
                            <a href="{{ route('admin.business-settings.web-app.third-party.fcm-index') }}" class="nav-link pb-2 px-0 pb-sm-3 active" data-slide="1">
                                <img src="{{asset_path('assets/admin/img/notify.png')}}" alt="">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.business-settings.web-app.third-party.fcm-config') }}" class="nav-link pb-2 px-0 pb-sm-3" data-slide="2">
                                <img src="{{asset_path('assets/admin/img/firebase2.png')}}" alt="">
                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="single-item-slider owl-carousel">
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{asset_path('assets/admin/img/firebase/slide-1.png')}}" alt="" class="mb-3">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{asset_path('assets/admin/img/firebase/slide-2.png')}}" alt="" class="mb-3">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{asset_path('assets/admin/img/firebase/slide-3.png')}}" alt="" class="mb-3">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{asset_path('assets/admin/img/email-templates/3.png')}}" alt="" class="mb-3">
