                                ...
                                <div class="payment--gateway-img">
                                    <img class="h--92px"
                                         src="{{ App\CentralLogics\Helpers::onErrorImage($additional_data != null ? $additional_data->gateway_image : '',
                                               asset('storage/app/payment_modules/gateway_image') . '/' . ($additional_data != null ? $additional_data->gateway_image : ''),
                                               asset_path('assets/admin/img/placeholder.png'), 'payment_modules/gateway_image/')}}"
