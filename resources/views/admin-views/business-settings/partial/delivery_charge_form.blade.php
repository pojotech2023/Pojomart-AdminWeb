                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="text-center">
                                                    <img class="my-4" src="{{ asset_path('assets/admin/svg/components/map.svg') }}" alt="{{ translate('info icon') }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <img src="{{ asset_path('assets/admin/svg/components/info.svg') }}" alt="{{ translate('image') }}" class="mb-4">
            ...
            <form id="importForm-{{$branch->id}}">
                ...
                <div class="modal-body">
                    <div class="text-center my-4">
                        <img src="{{ asset_path('assets/admin/svg/components/file.svg') }}" alt="{{ translate('image') }}" class="mb-4">
                        ...
                        <p>{{ translate('You can download the example file to understand how the file must be filled with proper data.') }}
                            <a href="{{asset_path('assets/area_bulk_format.xlsx')}}" download="" class="fz-16 btn-link">
