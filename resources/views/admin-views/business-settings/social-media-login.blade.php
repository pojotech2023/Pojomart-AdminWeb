                        ...
                        <div class="d-flex justify-content-between align-items-center w-100">
                            <div class="__social-media-login-top flex-grow-1">
                                <h5 class="card-title align-items-center">
                                    <img src="{{asset_path('assets/admin/img/modal/apple.png')}}" class="mr-1 w--20" alt="{{ translate('apple') }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-0"><b></b>
                    <div class="text-center mb-20">
                        <img src="{{asset_path('assets/admin/img/modal/apple.png')}}" alt="" class="mb-3">
