    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset_path('assets/admin/img/icons/business_setup2.png')}}" alt="{{ translate('Offline Payment') }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-center flex-column gap-3 text-center">
                        ...
                        <img width="100" src="{{asset_path('assets/admin/img/offline_payment.png')}}" alt="">
