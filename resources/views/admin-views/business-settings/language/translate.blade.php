...
@push('css_or_js')
    <link href="{{asset_path('assets/admin')}}/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
@endpush
...
@push('script')
    ...
    <script src="{{asset_path('assets/admin')}}/vendor/datatables/dataTables.bootstrap4.min.js"></script>
    <script>
