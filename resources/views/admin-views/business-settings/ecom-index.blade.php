                    ...
                    <div class="card-header">
                        <h5 class="card-title d-flex align-items-center">
                            <span class="card-header-icon mb-1 mr-2">
                                <img src="{{asset_path('assets/admin/img/bag.png')}}" class="w--17" alt="">
                            </span>
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control change-self-pickup-status"
                                            ...
                                            <span class="line--limit-1">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex ml-1" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('When this option is enabled the user may pick up their own order.')}}"><img src="{{asset_path('assets/admin/img/info-circle.svg')}}" alt="info">
                                                </span>
                                            </span>
                                        ...
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control deliveryman-self-registration"
                                            ...
                                            <span class="line--limit-1">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex ml-1" data-toggle="tooltip" data-placement="right"
                                                    ...
                                                    <img src="{{asset_path('assets/admin/img/info-circle.svg')}}" alt="info">
                                                </span>
                                            </span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        <div class="my-4">
                            <img src="{{ asset_path('assets/admin/svg/components/map-icon.svg') }}" alt="Checked Icon">
                        </div>
                        <div class="my-4">
                ...
                <div class="modal-body">
                    <div class="">
                        <div class="text-center mb-5">
                            <img src="{{ asset_path('assets/admin/svg/components/map-icon.svg') }}" alt="Unchecked Icon" class="mb-5">
                        ...
                        <div class="row g-2 ">
                            <div class="col-12 mb-2">
                                <a class="d-flex align-items-center border rounded px-3 py-2 g-1"
                                   ...
                                   target="_blank">
                                    <img src="{{ asset_path('assets/admin/svg/components/people.svg') }}" width="21" alt="">
                            ...
                            <div class="col-12 mb-2">
                                <a class="d-flex align-items-center border rounded px-3 py-2 g-1"
                                   ...
                                   target="_blank">
                                    <img src="{{ asset_path('assets/admin/svg/components/branch.svg') }}" width="21" alt="">
                                    <span>{{ translate('Map in Branch Coverage Area') }}</span>
                                </a>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="d-flex align-items-center border rounded px-3 py-2 g-1">
                                    <img src="{{ asset_path('assets/admin/svg/components/delivery-car.svg') }}" width="21" alt="">
                            ...
                            <div class="col-12 mb-2">
                                <a class="d-flex align-items-center border rounded px-3 py-2 g-1"
                                   ...
                                   target="_blank">
                                    <img src="{{ asset_path('assets/admin/svg/components/delivery-charge.svg') }}" width="21" alt="">
