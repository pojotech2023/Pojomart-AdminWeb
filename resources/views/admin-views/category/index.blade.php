                            ...
                            <div class="row align-items-end g-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="text-center mb-3">
                                        <img id="viewer"
                                            class="img--105"
                                            src="{{ asset_path('assets/admin/img/160x160/1.png') }}"
                                            alt="{{ translate('image') }}">
                                    </div>
                        ...
                        <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                            ...
                            @foreach($categories as $key=>$category)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ $category->imageFullPath }}" class="img--50 ml-3" alt="{{ translate('category') }}" onerror="this.src='{{ asset_path('assets/admin/img/160x160/1.png') }}'">
                                    </td>
...
@push('script_2')
    <script src="{{ asset_path('assets/admin/js/category.js') }}"></script>
    <script>
        "use strict";
