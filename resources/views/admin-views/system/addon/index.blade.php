...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{ asset_path('assets/admin/vendor/swiper/swiper-bundle.min.css')}}" />
    ...
    <div class="content container-fluid">
        <div class="d-flex justify-content-between mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-3">
                <img  class="avatar-img width-24" src="{{asset_path('assets/admin/img/addon-image.png')}}" alt="">
            ...
            <div class="text-primary d-flex align-items-center gap-3 font-weight-bolder" data-toggle="modal" data-target="#settingModal">
                ...
                <div class="ripple-animation" >
                    <img src="{{asset_path('assets/admin/img/info.svg')}}" class="svg" alt="">
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                            ...
                            <div class="mt-5 card px-3 py-2 d-none" id="progress-bar">
                                <div class="d-flex flex-wrap align-items-center gap-3">
                                    <div class="">
                                        <img width="24" src="{{asset_path('assets/admin/img/zip.png')}}" alt="">
                                    </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="d-flex gap-2 gap-sm-3 align-items-center">
                                @if ($data['is_published'] == 0)
                                    <button class="text-danger bg-transparent p-0 border-0 mr-2" data-toggle="modal" data-target="#deleteThemeModal_{{$key}}"><img src="{{asset_path('assets/admin/img/delete.svg')}}" class="svg" alt=""></button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75" src="{{asset_path('assets/admin/img/delete.png')}}" alt="">
                                                    </div>
                                ...
                                <button class="{{$data['is_published'] == 1 ? 'checkbox-color-primary' : 'text-muted'}} bg-transparent p-0 border-0" data-toggle="modal" data-target="#shiftThemeModal_{{$key}}"><img src="{{asset_path('assets/admin/img/check.svg')}}" class="svg" alt=""></button>
                                ...
                                <div class="modal fade" id="shiftThemeModal_{{$key}}" tabindex="-1" aria-labelledby="shiftThemeModalLabel_{{$key}}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="{{asset_path('assets/admin/img/shift.png')}}" alt="">
                                                </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                <img src="{{asset_path('assets/admin/img/addon_setting.png')}}" loading="lazy"
...
@push('script_2')
    <script src="{{ asset_path('assets/admin/js/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset_path('assets/admin/js/addon.js') }}"></script>
    <script href="{{ asset_path('assets/admin/vendor/swiper/swiper-bundle.min.js')}}"></script>
