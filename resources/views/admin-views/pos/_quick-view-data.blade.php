    ...
    <div class="modal--media">
        <div class="modal--media-avatar">
            <img class="img-fit rounded"
                src="{{ $product->identityImageFullPath[0] ?? asset_path('assets/admin/img/placeholder.png') }}"
                data-zoom="{{ $product->identityImageFullPath[0] ?? asset_path('assets/admin/img/placeholder.png') }}"
                alt="{{ $product->name }}"
                onerror="this.src='{{ asset_path('assets/admin/img/placeholder.png') }}'">
