        ...
        <div class="card">
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="h-30 d-flex gap-2 align-items-center btn btn-soft-info btn-sm border-info" href="{{route('admin.offer.flash.add-product',[$flash_deal['id']])}}">
                                        <img src="{{asset_path('assets/back-end/img/plus.svg')}}" class="svg" alt="">
            ...
            @if(count($flashDeals) == 0)
                <div class="text-center p-4">
                    <img class="w-120px mb-3" src="{{asset_path('assets/admin/svg/illustrations/sorry.svg')}}" alt="{{translate('Image Description')}}">
