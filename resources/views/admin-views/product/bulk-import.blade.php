        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/bulk.png')}}" class="w--20" alt="">
                </span>
                <span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-center mt-2">
                                ...
                                <a href="{{asset_path('assets/product_bulk_format.xlsx')}}" download="" class="text--primary-2">{{ translate('Download Here') }}</a>
                            </h5>
                            <div class="form-group mt-4">
                                <label class="drag--area mb-0 mx-auto cursor-pointer" ondrop="drop(event)" ondragover="allowDrop(event)">
                                    <img class="icon" src="{{asset_path('assets/admin/img/cloud.png')}}" alt="">
...
<script>
    $('#import-file').on('change', function(){
        ...
        $('.file--img').empty().append(`<div class="my-2"> <img src="{{asset_path('assets/admin/img/excel.png')}}" alt=""></div>`)
        }
    })
