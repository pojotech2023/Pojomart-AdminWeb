...
@push('css_or_js')
    ...
    <link href="{{asset_path('assets/admin/css/tags-input.min.css')}}" rel="stylesheet">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/add-product.png')}}" class="w--24" alt="">
                </span>
                <span>
    ...
    <script type="text/javascript">
        $(function () {
            $("#coba").spartanMultiImagePicker({
                ...
                maxFileSize: '',
                placeholderImage: {
                    image: '{{asset_path('assets/admin/img/upload-en.png')}}',
                    width: '100%'
                },
