    ...
    @if(Helpers::module_permission_check(MANAGEMENT_SECTION['dashboard_management']))
        <div class="content container-fluid">
            ...
            <div class="card mb-10px">
                <div class="card-body">
                    <div class="mb-3">
                        <h4 class="mb-0 text-107980">Plan Overview</h4>
                    </div>
                    <div class="plan-overview-grid">
                        <div class="plan-overview-grid__item">
                            <div class="plan-overview-card plan-overview-card--orange">
                                <div class="plan-overview-card__icon">
                                    <i class="tio-star"></i>
                                </div>
                                <div class="plan-overview-card__content">
                                    <span class="plan-overview-card__label">Current Plan</span>
                                    <h3 class="plan-overview-card__title">{{ $data['active_plan_name'] }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="plan-overview-grid__item">
                            <div class="plan-overview-card plan-overview-card--green">
                                <div class="plan-overview-card__content">
                                    <span class="plan-overview-card__label">{{ $data['plan_limit_overview']['category_limit']['label'] ?? 'Category' }}</span>
                                    <div class="plan-overview-card__stats">
                                        <div class="plan-overview-card__stat">
                                            <span>Total</span>
                                            <strong>{{ $data['plan_limit_overview']['category_limit']['total_limit'] ?? 0 }}</strong>
                                        </div>
                                        <div class="plan-overview-card__stat">
                                            <span>Active</span>
                                            <strong>{{ $data['plan_limit_overview']['category_limit']['active_limit'] ?? 0 }}</strong>
                                        </div>
                                        <div class="plan-overview-card__stat">
                                            <span>Balance</span>
                                            <strong>{{ $data['plan_limit_overview']['category_limit']['balance_limit'] ?? 0 }}</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="plan-overview-grid__item">
                            <div class="plan-overview-card plan-overview-card--blue">
                                <div class="plan-overview-card__content">
                                    <span class="plan-overview-card__label">{{ $data['plan_limit_overview']['sub_category_limit']['label'] ?? 'Sub Category' }}</span>
                                    <div class="plan-overview-card__stats">
                                        <div class="plan-overview-card__stat">
                                            <span>Total</span>
                                            <strong>{{ $data['plan_limit_overview']['sub_category_limit']['total_limit'] ?? 0 }}</strong>
                                        </div>
                                        <div class="plan-overview-card__stat">
                                            <span>Active</span>
                                            <strong>{{ $data['plan_limit_overview']['sub_category_limit']['active_limit'] ?? 0 }}</strong>
                                        </div>
                                        <div class="plan-overview-card__stat">
                                            <span>Balance</span>
                                            <strong>{{ $data['plan_limit_overview']['sub_category_limit']['balance_limit'] ?? 0 }}</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="plan-overview-grid__item">
                            <div class="plan-overview-card plan-overview-card--cyan">
                                <div class="plan-overview-card__icon">
                                    <i class="tio-box"></i>
                                </div>
                                <div class="plan-overview-card__content">
                                    <span class="plan-overview-card__label">{{ $data['plan_limit_overview']['product_limit']['label'] ?? 'Product' }}</span>
                                    <div class="plan-overview-card__stats">
                                        <div class="plan-overview-card__stat plan-overview-card__stat--nowrap">
                                            <span>Total</span>
                                            <strong>{{ $data['plan_limit_overview']['product_limit']['total_limit'] ?? 0 }}</strong>
                                        </div>
                                        <div class="plan-overview-card__stat">
                                            <span>Active</span>
                                            <strong>{{ $data['plan_limit_overview']['product_limit']['active_limit'] ?? 0 }}</strong>
                                        </div>
                                        <div class="plan-overview-card__stat">
                                            <span>Balance</span>
                                            <strong>{{ $data['plan_limit_overview']['product_limit']['balance_limit'] ?? 0 }}</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="plan-overview-grid__item">
                            <div class="plan-overview-card plan-overview-card--violet">
                                <div class="plan-overview-card__content">
                                    <span class="plan-overview-card__label">{{ $data['plan_limit_overview']['banner_limit']['label'] ?? 'Banner' }}</span>
                                    <div class="plan-overview-card__stats">
                                        <div class="plan-overview-card__stat">
                                            <span>Total</span>
                                            <strong>{{ $data['plan_limit_overview']['banner_limit']['total_limit'] ?? 0 }}</strong>
                                        </div>
                                        <div class="plan-overview-card__stat">
                                            <span>Active</span>
                                            <strong>{{ $data['plan_limit_overview']['banner_limit']['active_limit'] ?? 0 }}</strong>
                                        </div>
                                        <div class="plan-overview-card__stat">
                                            <span>Balance</span>
                                            <strong>{{ $data['plan_limit_overview']['banner_limit']['balance_limit'] ?? 0 }}</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="btn--container justify-content-between align-items-center mb-2 pb-1">
                        <h5 class="card-title mb-2">
                            <img src="{{asset_path('assets/admin/img/business-analytics.png')}}" alt="" class="{{ translate('card-icon')}}">
                        ...
                        <div class="card h-100 bg-white">
                            <div class="card-body p-20px pb-0">
                                <div class="btn--container justify-content-between align-items-center">
                                    <h5 class="card-title mb-2">
                                        <img src="{{asset_path('assets/admin/img/order-statistics.png')}}" alt=""
                                             class="card-icon">
...
.plan-overview-card {
    ...
    color: #fff;
                    ...
                    .plan-overview-card--orange {
                        background: linear-gradient(135deg, #ffb44d, #ff9f2f);
                    }

                    .plan-overview-card--blue {
                        background: linear-gradient(135deg, #2979e8, #1c63d6);
                    }

                    .plan-overview-card--green {
                        background: linear-gradient(135deg, #10a36d, #0f8f61);
                    }

                    .plan-overview-card--cyan {
                        background: linear-gradient(135deg, #56acef, #42a1ea);
                    }

                    .plan-overview-card--violet {
                        background: linear-gradient(135deg, #7856ef, #5e3fe0);
                    }

                    .plan-overview-card__icon {
                        font-size: 28px;
                        line-height: 1;
                        align-self: flex-start;
                    }

                    .plan-overview-card__content {
                        flex: 1;
                        display: flex;
                        flex-direction: column;
...
.plan-overview-card__stat span{
    font-size: 11px;
    opacity: 0.9;
}

.plan-overview-card__stat strong{
    font-size: 20px;
    font-weight: 700;
}
                    .plan-overview-card__stat span {
                    ...
                    .plan-overview-card__stat--nowrap span {
                        white-space: nowrap;
                    }
...
@media (max-width: 575px) {
    .plan-overview-grid {
        grid-template-columns: 1fr;
            ...
            @push('script')
                <script src="{{asset_path('assets/admin')}}/vendor/chart.js/dist/Chart.min.js"></script>
                <script src="{{asset_path('assets/admin')}}/vendor/chart.js.extensions/chartjs-extensions.js"></script>
                <script src="{{asset_path('assets/admin')}}/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
                <script src="{{asset_path('assets/admin/js/apex-charts/apexcharts.js')}}"></script>
                <script src="{{asset_path('assets/admin/js/apex-charts/dashboard.js')}}"></script>
            @endpush
