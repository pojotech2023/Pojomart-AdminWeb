        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-3">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/wallet.png')}}" class="width-24" alt="{{ translate('wallet') }}">
                </span>
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{asset_path('assets/admin/img/image_127.png')}}" alt="{{ translate('image') }}" class="mb-20">
...
@push('script_2')
    <script src="{{ asset_path('assets/admin/js/wallet-bonus.js') }}"></script>
@endpush
