        ...
        <div class="page-header">
            <h1 class="page-header-title text-capitalize">
                <div class="card-header-icon d-inline-flex mr-2 img">
                    <img src="{{asset_path('assets/admin/img/point.png')}}" alt="{{ translate('loyalty_point') }}" class="width-24">
                </div>
                <span>
        ...
        <div class="row g-3">
            ...
            <div class="col-sm-4">
                <div class="resturant-card dashboard--card bg--2">
                    ...
                    <img class="resturant-icon" src="{{asset_path('assets/admin/img/dashboard/3.png')}}" alt=" {{ translate('image') }}">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="resturant-card dashboard--card bg--3">
                    ...
                    <img class="resturant-icon" src="{{asset_path('assets/admin/img/dashboard/4.png')}}" alt=" {{ translate('image') }}">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="resturant-card dashboard--card bg--1">
                    ...
                    <img class="resturant-icon" src="{{asset_path('assets/admin/img/dashboard/1.png')}}" alt=" {{ translate('image') }}">
                </div>
            </div>
        </div>
        <div class="card mt-3">
                ...
                <div class="table-responsive">
                    ...
                    @if(!$transactions)
                        <div class="empty--data">
                            <img src="{{asset_path('assets/admin/img/empty.png')}}" alt="public">
                            <h5>
