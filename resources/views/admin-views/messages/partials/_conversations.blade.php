                                    ...
                                    @foreach($image_array as $image)
                                        <div>
                                            <a href="{{$image}}" data-lightbox >
                                                <img class="__img-120" src="{{$image}}" onerror="this.src='{{asset_path('assets/admin/img/900x400/img1.jpg')}}'" alt="{{ translate('image') }}"/>
                                            </a>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            @if($con->image != null && $con->image != "null" && count(json_decode($con->image, true)) > 0)
                                ...
                                <div class="__gap-2">
                                    @foreach($image_array as $imageKey=>$image)
                                        @php($image_url = $image)
                                        <div>
                                            <a href="{{asset('storage/app/conversation')}}/{{$image}}" data-lightbox >
                                                <img class="__img-120" src="{{asset('storage/app/conversation')}}/{{$image}}" /></a>
                                        </div>
                                    @endforeach
                                </div>
                            @endif
...
<script src="{{asset_path('assets/admin')}}/js/tags-input.min.js"></script>
<script src="{{asset_path('assets/admin/js/spartan-multi-image-picker.js')}}"></script>
<script>
