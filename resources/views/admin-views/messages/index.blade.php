        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/messages.png')}}" class="w--24" alt="{{ translate('message') }}">
                </span>
        ...
        <div class="row g-0">
                    ...
                    <div class="card-header border-0 px-0 mx-20px">
                        <div class="conv-open-user w-100">
                            <img class="w-47px"
                                ...
                                alt="{{ translate('admin') }}"
                                onerror="this.src='{{ asset_path('assets/admin/img/160x160/img2.jpg') }}'">
                            <div class="info">
            ...
            <div class="col-md-8 col-xxl-9 pl-0 view-conversion" id="view-conversation">
                <div class="h-100 d-flex justify-content-center align-items-center card __shadow rounded-left-0 py-5 py-md-0 text-center">
                    <img src="{{asset_path('assets/admin/img/view-conv.png')}}" class="mw-100" alt="{{ translate('image') }}">
                    <div>
