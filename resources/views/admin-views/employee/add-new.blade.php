                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <div class="text-center mb-4">
                                ...
                                src="{{asset_path('assets/admin/img/upload-vertical.png')}}" alt="{{ translate('employee') }}"/>
                            </div>
...
@push('script_2')
    ...
    <script src="{{asset_path('assets/admin')}}/js/select2.min.js"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#coba").spartanMultiImagePicker({
                ...
                maxFileSize: '',
                placeholderImage: {
                    image: '{{asset_path('assets/admin/img/upload-vertical.png')}}',
                    width: '100%'
                },
