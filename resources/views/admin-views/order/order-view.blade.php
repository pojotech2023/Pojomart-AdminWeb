...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{asset_path('assets/admin/css/lightbox.min.css')}}">
@endpush
@section('content')
        ...
        <div class="page-header d-flex justify-content-between">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/order.png')}}" class="w--20" alt="">
                </span>
                <span>
                                            ...
                                            <div class="media media--sm">
                                                <div class="avatar avatar-xl mr-3">
                                                    ...
                                                    <img class="img-fluid rounded aspect-ratio-1"
                                                         src="{{ $detail->product->identityImageFullPath[0] ?? asset_path('assets/admin/img/160x160/2.png') }}"
                                                        alt="{{translate('Image Description')}}">
                                                    @else
                                                        <img
                                                        src="{{asset_path('assets/admin/img/160x160/2.png')}}"
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            ...
                            @if($order->is_guest == 1)
                                <div class="media align-items-center deco-none customer--information-single">
                                    <div class="avatar avatar-circle">
                                        <img class="avatar-img" src="{{asset_path('assets/admin/img/admin.jpg')}}" alt="{{ translate('Image Description')}}">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    @foreach($order->order_image as $orderImage)
                                        <a class="avatar m-1 w-75px h-auto" href="{{asset('storage/app/order/' . $orderImage->image)}}" data-lightbox>
                                            <img class="aspect-1 avatar-img object-cover" src="{{ asset('storage/app/order/' . $orderImage->image) }}" alt="{{ translate('Image Description')}}">
                                        </a>
                                    @endforeach
                                </div>
                            </div>
