        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/add_branch.png')}}" class="w--20" alt="{{ translate('branch') }}">
                </span>
                <span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="d-flex flex-column justify-content-center h-100">
                                                ...
                                                <label class="upload--squire">
                                                    ...
                                                    <img id="viewer" src="{{asset_path('assets/admin/img/upload-vertical.png')}}" alt="{{ translate('branch image') }}"/>
                                                </label>
                                            </div>
                                        </div>
...
@push('script_2')
    ...
    <script src="{{ asset_path('assets/admin/js/branch.js') }}"></script>
@endpush
