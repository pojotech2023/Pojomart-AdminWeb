    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="media align-items-center">
                <img src="{{asset_path('assets/admin/img/expense_report.png')}}" class="w--20" alt="">
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-3">
                        <div class="flex-grow-1 color_card">
                            ...
                            <div class="circle">
                                <img src="{{asset_path('assets/admin/img/expense.svg')}}" alt="">
                            </div>
                        </div>
                        <div class="flex-grow-1 color_card warning">
                            ...
                            <div class="circle">
                                <img src="{{asset_path('assets/admin/img/free-delivery.svg')}}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="flex-grow-1 color_card info">
                            ...
                            <div class="circle">
                                <img src="{{asset_path('assets/admin/img/coupon-discount.svg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="center-chart-area">
                        <div class="d-flex align-items-center gap-2 mb-4">
                            <img width="20" src="{{asset_path('assets/admin/img/order-statistics.png')}}" alt="">
...
{{--                                        <a class="action-btn" href="#" download><i class="tio-download-to"></i></a>--}}
                    ...
                    @if(count($expenseTransactionsTable)==0)
                        <div class="text-center p-4">
                            <img class="mb-3 w-120px" src="{{asset_path('assets/admin/svg/illustrations/sorry.svg')}}" alt="{{ translate('Image Description')}}">
...
@push('script_2')
    ...
    <script src="{{ asset_path('assets/admin') }}/js/Chart.min.js"></script>
    <script src="{{ asset_path('assets/admin') }}/js/chart.js.extensions/chartjs-extensions.js"></script>
    <script src="{{ asset_path('assets/admin') }}/js/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
