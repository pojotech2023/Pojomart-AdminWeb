    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="media align-items-center">
                <img class="w--20" src="{{asset_path('assets/admin')}}/svg/illustrations/credit-card.svg"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.product.view',[$product['id']])}}" target="_blank" class="product-list-media">
                                        <img src="{{ $detail->product ? ($detail->product->identityImageFullPath[0] ?? asset_path('assets/admin/img/160x160/2.png')) : asset_path('assets/admin/img/160x160/2.png') }}">
