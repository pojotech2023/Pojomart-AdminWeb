    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="media align-items-center mb-2">
                <div class="">
                    <img src="{{asset_path('assets/admin/img/order-img.png')}}" class="w--20" alt="">
                </div>
...
@push('script_2')
    ...
    <script
        src="{{asset_path('assets/admin')}}/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js"></script>
    <script src="{{asset_path('assets/admin')}}/js/hs.chartjs-matrix.js"></script>
    <script src="{{asset_path('assets/admin/js/flatpicker.js')}}"></script>
    <script src="{{asset_path('assets/admin/js/order-report.js')}}"></script>
@endpush
