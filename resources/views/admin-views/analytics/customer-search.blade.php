        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/analytics_logo.png')}}" class="w--20" alt="{{ translate('analytics') }}">
                </span>
                <span>
                                    ...
                                    <div class="avatar avatar-lg">
                                        <a href="{{$value->customer ? route('admin.customer.view',[$value->customer['id']]) : '#'}}" class="product-list-media">
                                            <img class="rounded-full"
                                                 src="{{$value->customer->imageFullPath ?? asset_path('assets/admin/img/160x160/2.png')}}"
                    ...
                    @if(count($customersData) == 0)
                        <div class="text-center p-4">
                            <img class="w-120px mb-3"
                                 src="{{asset_path('assets/admin/svg/illustrations/sorry.svg')}}"
                                 alt="{{ translate('image') }}">
