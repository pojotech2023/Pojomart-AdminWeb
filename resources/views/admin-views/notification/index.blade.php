        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/notification.png')}}" class="w--20" alt="{{ translate('notification') }}">
                </span>
                <span>
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex flex-column justify-content-center h-100">
                                        ...
                                        <label class="upload--vertical mt-auto">
                                            ...
                                            <img id="viewer" src="{{asset_path('assets/admin/img/upload-vertical.png')}}" alt="notification image"/>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="table-responsive datatable-custom">
                                    ...
                                    <td>
                                        @if($notification['image']!=null)
                                            <img class="img-vertical-150"
                                                 ...
                                                 onerror="this.src='{{ asset_path('assets/admin/img/upload-vertical.png') }}'">
                                        @else
                        ...
                        @if(count($notifications)==0)
                            <div class="text-center p-4">
                                <img class="mb-3 width-7rem" src="{{asset_path('assets/admin')}}/svg/illustrations/sorry.svg" alt="{{ translate('image') }}">
...
@push('script_2')
<script src="{{ asset_path('assets/admin/js/upload-single-image.js') }}"></script>
@endpush
