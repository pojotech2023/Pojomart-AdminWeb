...
<div class="col-sm-6 col-lg-3">
    <a class="dashboard--card h-100" href="{{route('admin.orders.list',['pending'])}}">
        ...
        <img src="{{asset_path('assets/admin/img/dashboard/pending.png')}}" alt="" class="dashboard-icon">
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    <a class="dashboard--card h-100" href="{{route('admin.orders.list',['confirmed'])}}">
        ...
        <img src="{{asset_path('assets/admin/img/dashboard/confirmed.png')}}" alt="" class="dashboard-icon">
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    <a class="dashboard--card h-100" href="{{route('admin.orders.list',['processing'])}}">
        ...
        <img src="{{asset_path('assets/admin/img/dashboard/packaging.png')}}" alt="" class="dashboard-icon">
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    <a class="dashboard--card h-100" href="{{route('admin.orders.list',['out_for_delivery'])}}">
        ...
        <img src="{{asset_path('assets/admin/img/dashboard/out-for-delivery.png')}}" alt="" class="dashboard-icon">
    </a>
</div>
    ...
    <a class="order--card h-100" href="{{route('admin.orders.list',['delivered'])}}">
        <div class="d-flex justify-content-between align-items-center">
            <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                <img src="{{asset_path('assets/admin/img/delivery/1.png')}}" alt="dashboard" class="oder--card-icon">
