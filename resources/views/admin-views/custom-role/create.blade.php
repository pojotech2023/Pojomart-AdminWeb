    ...
    <div class="page-header">
        <h1 class="page-header-title">
            <span class="page-header-icon">
                <img src="{{asset_path('assets/admin/img/employee.png')}}" class="w--24" alt="{{ translate('employee') }}">
            </span>
            <span>
                ...
                <div class="hs-unfold ml-sm-3">
                    ...
                    <div id="usersExportDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-sm-right">
                        ...
                        <a id="export-excel" class="dropdown-item" href="{{route('admin.custom-role.export')}}">
                            <img class="avatar avatar-xss avatar-4by3 mr-2" src="{{asset_path('assets/admin')}}/svg/components/excel.svg" alt="{{ translate('excel') }}">
                            {{translate('excel')}}
                        </a>
                    </div>
                </div>
...
@push('script_2')
    <script src="{{ asset_path('assets/admin/js/custom-role.js') }}"></script>
@endpush
