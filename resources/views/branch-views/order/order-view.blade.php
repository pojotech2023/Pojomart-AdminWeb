        ...
        <div class="page-header d-flex justify-content-between">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/order.png')}}" class="w--20" alt="{{ translate('orders') }}">
                </span>
                <span>
                                            ...
                                            <td>
                                                <div class="media media--sm">
                                                    <div class="avatar avatar-xl mr-3">
                                                        ...
                                                        @else
                                                            <img src="{{asset_path('assets/admin/img/160x160/2.png')}}"
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        ...
                        @if($order->is_guest == 1)
                            <div class="media align-items-center deco-none customer--information-single">
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img" src="{{asset_path('assets/admin/img/admin.jpg')}}" alt="Image Description">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    @foreach($order->order_image as $orderImage)
                                        <a class="avatar m-1 w-75px h-auto" href="{{asset('storage/order/' . $orderImage->image)}}" data-lightbox>
                                            <img class="aspect-1 avatar-img object-cover" src="{{ asset('storage/order/' . $orderImage->image) }}" alt="{{ translate('Image Description')}}">
                                        </a>
                                    @endforeach
                                </div>
                            </div>
