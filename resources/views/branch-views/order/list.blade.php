        ...
        <div class="page-header">
            <h1 class="mb-0 page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset_path('assets/admin/img/all_orders.png')}}" class="w--20" alt="{{ translate('orders') }}">
                </span>
                <span >
                    ...
                    <div class="row g-3 g-sm-4 g-md-3 g-lg-4">
                            ...
                            <a class="order--card h-100" href="{{route('branch.orders.list',['pending'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset_path('assets/admin/img/delivery/pending.png')}}" alt="{{ translate('pending') }}" class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order--card h-100" href="{{route('branch.orders.list',['confirmed'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset_path('assets/admin/img/delivery/confirmed.png')}}" alt="{{ translate('confirmed') }}" class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order--card h-100" href="{{route('branch.orders.list',['processing'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset_path('assets/admin/img/delivery/processing.png')}}" alt="{{ translate('processing') }}" class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order--card h-100" href="{{route('branch.orders.list',['delivered'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset_path('assets/admin/img/delivery/1.png')}}" alt="{{ translate('delivered') }}" class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order--card h-100" href="{{route('branch.orders.list',['canceled'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset_path('assets/admin/img/delivery/2.png')}}" alt="{{ translate('Canceled') }}" class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order--card h-100" href="{{route('branch.orders.list',['returned'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset_path('assets/admin/img/delivery/3.png')}}" alt="{{ translate('returned') }}" class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order--card h-100" href="{{route('branch.orders.list',['failed'])}}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{asset_path('assets/admin/img/delivery/4.png')}}" alt="{{ translate('failed_to_deliver') }}" class="oder--card-icon">
