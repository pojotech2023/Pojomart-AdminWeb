    ...
    <div class="modal--media">
        <div class="modal--media-avatar">
            @if (!empty(json_decode($product['image'],true)))
                <img src="{{ $product->identityImageFullPath[0] ?? asset_path('assets/admin/img/160x160/2.png') }}"
                 data-zoom="{{ $product->identityImageFullPath[0] ?? asset_path('assets/admin/img/160x160/2.png') }}"
