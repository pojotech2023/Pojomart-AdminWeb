                ...
                <a href="https://docs.6amtech.com/docs-grofresh/intro" class="d-flex align-items-center gap-1"
                   target="_blank">
                    ...
                    <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                        ...
                        <img src="{{asset_path('assets/installation')}}/assets/img/svg-icons/info.svg" class="svg" alt="">
                    </span>
                </a>
            </div>
                    ...
                    <div class="row g-4 g-md-5">
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img
                                    src="{{asset_path('assets/installation')}}/assets/img/svg-icons/php-version.svg"
                                    alt="">
                                <div
                                    ...
                                    @if ($phpVersion >= 8.0)
                                        <img width="20"
                                             src="{{asset_path('assets/installation')}}/assets/img/svg-icons/check.png"
                                             alt="">
                                    @else
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              ...
                                              data-bs-title="Your php version in server is lower than 8.0 version
                                                ...
                                                <img
                                                    src="{{asset_path('assets/installation')}}/assets/img/svg-icons/info.svg"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img
                                    src="{{asset_path('assets/installation')}}/assets/img/svg-icons/curl-enabled.svg"
                                    alt="">
                                <div
                                    class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                    Curl Enabled
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img
                                    src="{{asset_path('assets/installation')}}/assets/img/svg-icons/route-service.svg"
                                    alt="">
                                <div
                                    class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                    .env File Permission
