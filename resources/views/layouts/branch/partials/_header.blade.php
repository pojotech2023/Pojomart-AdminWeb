                                   ...
                                   <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img"
                                            onerror="this.src='{{asset_path('assets/admin/img/160x160/img1.jpg')}}'"
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        <div class="avatar avatar-sm avatar-circle mr-2">
                                            <img class="avatar-img"
                                                src="{{ App\CentralLogics\Helpers::onErrorImage(auth('branch')->user()->image, asset('storage/branch') . '/' . auth('branch')->user()->image, asset_path('assets/admin/img/160x160/img1.jpg'), 'branch/')}}"
                                                alt="{{ translate('logo') }}">
                                        </div>
