...
<head>
    ...
    <link rel="stylesheet" href="{{asset_path('assets/admin')}}/css/vendor.min.css">
    <link rel="stylesheet" href="{{asset_path('assets/admin')}}/vendor/icon-set/style.css">
    <link rel="stylesheet" href="{{asset_path('assets/admin')}}/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset_path('assets/admin/css/owl.min.css')}}">
    <link rel="stylesheet" href="{{asset_path('assets/admin')}}/css/theme.minc619.css?v=1.0">
    <link rel="stylesheet" href="{{asset_path('assets/admin')}}/css/style.css">
    @stack('css_or_js')

    <script
        src="{{asset_path('assets/admin')}}/vendor/hs-navbar-vertical-aside/hs-navbar-vertical-aside-mini-cache.js"></script>
    <link rel="stylesheet" href="{{asset_path('assets/admin')}}/css/toastr.css">
    <link rel="stylesheet" href="{{asset_path('assets/admin')}}/css/custom-helper.css">
</head>
        ...
        <div class="col-md-12">
            <div class="d-none" id="loading">
                <div class="loader-image">
                    <img width="200" src="{{asset_path('assets/admin/img/loader.gif')}}">
                </div>
            </div>
        </div>
    </div>
...
<script src="{{asset_path('assets/admin')}}/js/custom.js"></script>

@stack('script')

<script src="{{asset_path('assets/admin')}}/js/vendor.min.js"></script>
<script src="{{asset_path('assets/admin')}}/js/theme.min.js"></script>
<script src="{{asset_path('assets/admin')}}/js/sweet_alert.js"></script>
<script src="{{asset_path('assets/admin')}}/js/toastr.js"></script>
<script src="{{asset_path('assets/admin/js/owl.min.js')}}"></script>
<script src="{{asset_path('assets/admin/js/firebase.min.js')}}"></script>
...
@stack('script_2')
<audio id="myAudio">
    <source src="{{asset_path('assets/admin/sound/notification.mp3')}}" type="audio/mpeg">
</audio>
...
<!-- IE Support -->
<script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="{{asset_path('assets/admin')}}/vendor/babel-polyfill/polyfill.min.js"><\/script>');
</script>
</body>
</html>
