<div id="sidebarMain" class="d-none">
    @php($planService = app(\App\Services\PlanLimitService::class))
    @php($activePlanName = $planService->getActivePlanDisplayName())
    @php($minimumLimitsLeft = $planService->getMinimumRemainingCount())
    <aside
                ...
                <div class="navbar-brand-wrapper justify-content-between">
                    ...
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}" aria-label="Front">
                        <img class="w-100 side-logo"
                             src="{{ App\CentralLogics\Helpers::onErrorImage($logo, asset('storage/app/public/restaurant') . '/' . $logo, asset_path('assets/admin/img/160x160/img2.jpg'), 'restaurant/') }}"
                             alt="{{ translate('logo') }}">
                    </a>
...
{{--                                    </li>--}}
                    ...
                    <div class="px-3 pb-4 pt-3">
                        ...
                        <a href="{{ route('admin.pricing-plan') }}" style="display:block;text-decoration:none;">
                            <div style="display:flex;align-items:center;gap:12px;width:100%;padding:14px 14px;border-radius:14px;background:#2f3448;border:1px solid rgba(255,255,255,0.14);box-shadow:0 10px 24px rgba(0,0,0,0.22);">
                                <div style="width:38px;height:38px;border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;background:#f5c451;">
                                    <i class="tio-star" style="color:#5e4200;font-size:18px;"></i>
                                </div>
                                <div style="min-width:0;">
                                    <div style="color:#ffffff;font-size:15px;font-weight:700;line-height:1.2;">Upgrade Plan</div>
                                    {{-- <div style="color:rgba(255,255,255,0.78);margin-top:3px;font-size:12px;font-weight:600;line-height:1.2;">{{ $minimumLimitsLeft }} limits left</div> --}}
                                </div>
                            </div>
                        </a>
                    </div>
