                                   ...
                                   <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img"
                                             src="{{ App\CentralLogics\Helpers::onErrorImage(auth('admin')->user()->image, asset('storage/app/admin') . '/' . auth('admin')->user()->image, asset('assets/admin/img/160x160/img1.jpg'), 'admin/')}}"
                                             alt="{{ translate('logo') }}">
