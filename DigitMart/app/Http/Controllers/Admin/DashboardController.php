...
class DashboardController extends Controller
{
    ...
    public function dashboard(): View|Factory|Application
    {
        ...
        $data['active_plan_name'] = $this->planLimitService->getActivePlanDisplayName();
        $data['plan_limit_overview'] = $this->planLimitService->getDashboardLimitOverview();
        $data['plan_remaining_limits'] = $this->planLimitService->getRemainingCounts();
        $data['minimum_limits_left'] = $this->planLimitService->getMinimumRemainingCount();
