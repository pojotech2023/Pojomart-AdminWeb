...
class BusinessSettingsController extends Controller
{
    ...
    public function businessSettingsIndex(): View|Factory|Application
    {
        ...
        $logo = Helpers::onErrorImage($logoName, asset('storage/app/public/restaurant') . '/' . $logoName, asset_path('assets/admin/img/160x160/img2.jpg'), 'restaurant/');

        $favIconName = Helpers::get_business_settings('fav_icon');
        $favIcon = Helpers::onErrorImage($favIconName, asset('storage/app/public/restaurant') . '/' . $favIconName, asset_path('assets/admin/img/160x160/img2.jpg'), 'restaurant/');
