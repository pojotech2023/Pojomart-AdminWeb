...
class OfferController extends Controller
{
    ...
    public function addFlashSaleProduct($flash_deal_id): View|Factory|Application
    {
        ...
        $categories = $this->category->where(['position' => 0])->orderBy('name', 'asc')->get();

        return view('admin-views.offer.add-product-index', compact('flashDeal', 'flashDealProducts', 'products', 'categories'));
    }
